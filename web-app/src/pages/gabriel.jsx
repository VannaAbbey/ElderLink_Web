...
export default function Gabriel() {
  ...
  const elderlyInHouse = elderlyList.filter(elder => elder.house_id === "H005");
    ...
    <div className="elderly-profile-container">
      ...
      <div className="elderly-profile-header">
        ...
        <div className="header-center">
          <img src="/images/Gabriel.png" alt="Gabriel" className="header-image" />
          <h1 className="header-title">House of St. Gabriel</h1>
        </div>
      </div>
