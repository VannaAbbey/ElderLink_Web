    ...
    <div className="elderly-profile-container">
      ...
      <div className="tab-content">
              ...
              <div className="house-list">
                {houses.map((house) => (
                  <div
                    ...
                    onClick={() => navigate(`/house/${house.house_id}`)} // ✅ Navigate to HouseView
                  >
                    <img
                      src={houseImages[house.house_id] || "/images/default-house.png"}
                      alt={house.house_name}
                      className="house-image"
                    />
                    <p className="house-name">{house.house_name}</p>
                    <p className="house-desc">
                      {houseDescriptions[house.house_id] || "Click to view elderly"}
                    </p>
                  </div>
                ))}
              </div>
        ...
        {activeTab === "notifications" && (
          <p className="notifications-placeholder">Notifications section will be here.</p>
        )}
      </div>
    </div>
  );
