...
export default function Emmanuel() {
  ...
  const elderlyInHouse = elderlyList.filter(elder => elder.house_id === "H002");
    ...
    <div className="elderly-profile-container">
      ...
      <div className="elderly-profile-header">
        ...
        <div className="header-center">
          <img src="/images/Emmanuel.png" alt="Emmanuel" className="header-image" />
          <h1 className="header-title">House of St. Emmanuel</h1>
        </div>
      </div>
