...
export default function Rose() {
  ...
  const elderlyInHouse = elderlyList.filter(elder => elder.house_id === "H004");
    ...
    <div className="elderly-profile-container">
      ...
      <div className="elderly-profile-header">
        ...
        <div className="header-center">
          <img src="/images/Rose.png" alt="Rose" className="header-image" />
          <h1 className="header-title">House of St. Rose</h1>
        </div>
      </div>
