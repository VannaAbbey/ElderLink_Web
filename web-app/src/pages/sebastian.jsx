...
export default function Sebastian() {
  ...
  const elderlyInHouse = elderlyList.filter(elder => elder.house_id === "H001");
    ...
    <div className="elderly-profile-container">
      ...
      <div className="elderly-profile-header">
        ...
        <div className="header-center">
          <img src="/images/Sebastian.png" alt="Sebastian" className="header-image" />
          <h1 className="header-title">House of St. Sebastian</h1>
        </div>
      </div>
